...
// server action imported from a separate server module
...
export default function AdminProjectPage() {
  ...
  const [formData, setFormData] = useState({
    title: '',
    description: '',
    media: [] as Array<{ url: string; type: string; publicId: string }>,
  });
  ...
  return (
    <div className='section footer min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8'>
      <div className='section-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        {/* Header */}
        <div className='mb-8'>
        ...
        {activeTab === 'create' && (
          <div className='spacing max-w-3xl mx-auto'>
            <div className='spacing bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-10'>
              ...
              <form action={createProjectAction} className='spacing space-y-8'>
                <div>
